 ...
 * *********************************************************
 */
package bravahome.common.client.pdf.impl;
...
public class PrintTextLocations extends PDFTextStripper {
    ...
    {
        /*
         * run command: sudo java PrintTextLocations file.pdf WORD1,WORD2,....
         */
        // first argument to pdf filepath
        //File input = new File(args[0]);
        File input = new File(Config.getSamplePath() + "/invoice-20170225.pdf");

        // second argument words to seek
        //seek = args[1];
        seek = "Account Sid:,Invoice Date:";
        seekA = seek.split(",");
